...
# baseUrlPaginator: The URL of the paginator    
# countOfAllData: The total number of data
# pageNumber: The current page number
# limit: The number of data to be displayed per page
def paginator(baseUrlPaginator, countOfAllData, pageNumber, limit):
    ...
    return {"page": page, "startNumber": startNumber, "limit": limit, "baseUrlPaginator": baseUrlPaginator}